...
#define IsExtendedPin(p)    (((p) >= 32) && ((p) < 64))
    ...
    #define ANALYZER_MASTER_SPI_SCLK    42
    #define ANALYZER_MASTER_SPI_MOSI    41
    #define ANALYZER_MASTER_SPI_MISO    48
    #define ANALYZER_MASTER_SPI_CS      47
    #define ANALYZER_READER_PIN_READY   40
...
#if (FIRMWARE_TYPE == TYPE_ANALYZER_READER) && (EN_DRIVER_SPI_TOUCH == ENABLE)
